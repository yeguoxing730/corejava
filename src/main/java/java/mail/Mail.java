...
public class Mail {
    ...
    // SMTP邮件服务器 
    private final static String HOST = "10.80.81.132";
    ...
    // 发件人 
    private static String from = "Guoxing.ye@thomsonreuters.com";

    // 收件人 
    private static String to = "Guoxing.ye@thomsonreuters.com";
    ...
    public static void sendTextEmail() throws Exception {
        ...
        // 设置邮件主题 
        message.setSubject("使用javamail发送简单文本邮件", "gb2312");
        // 设置收件人 
        message.setRecipient(RecipientType.TO, new InternetAddress(to));
        // 设置发送时间 
        message.setSentDate(new Date());
        // 设置纯文本内容为邮件正文 
        message.setText("email test!!!", "utf-8");
        // 保存并生成最终的邮件内容 
        message.saveChanges();
    ...
    public static void sendMultipleEmail() throws Exception {
        ...
        htmlContent.setContent("emailcontent", "text/html;charset=gbk");
